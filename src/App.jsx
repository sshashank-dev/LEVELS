...
//   useEffect(() => {
//     // Increase delay to 800ms to prevent spamming
//     const timer = setTimeout(async () => {
//       if (searchQuery.length > 2) {
//         setView("search");
//         // This will now go through your Vite proxy automatically
      ...
      <div className="flex-1 flex flex-col relative min-w-0">
        ...
        >
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="hidden sm:block flex-shrink-0 text-[10px] font-black tracking-[0.5em] text-white/60 uppercase whitespace-nowrap">
              CORE_SYSTEM
            </div>

            <div className="flex-1 relative group mx-3 md:mx-6 lg:mx-10">

              <div className="relative z-10 w-full">

                <Search
                  size={14}
                  className="absolute left-4 lg:left-5 top-1/2 -translate-y-1/2 text-white/40"
                />
              ...
              >
                  ...
                  <div className="space-y-16 lg:space-y-24">
                    ...
                    {Object.entries(FEATURED_CONTENT).map(([category, songs]) => (
                      <section key={category}>
                        ...
                        <h2 className="text-xl lg:text-2xl font-black italic uppercase tracking-tighter mb-6 lg:mb-10 opacity-70">
                          {category.replace(/_/g, " ")}
                        </h2>
                        ...
                        <div className="horizontal-glide-container no-scrollbar">
                          ...
                          {songs.map((song) => (
                            <div
                              key={song.id}
                              className="glide-item w-[150px] sm:w-[180px] lg:w-[220px]"
                            >
                              <SongCard
                                track={song}
                                collection={songs}
                    ...
                    <div className="pt-16 lg:pt-20 border-t border-white/5">

                      <div className="flex flex-col items-center mb-16 lg:mb-24 text-center">

                        <span className="text-[10px] font-mono tracking-[0.8em] text-white/20 uppercase mb-4">
                          Establishing_Connection
                        </span>

                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-black italic uppercase tracking-tighter">
                          Immortal_Vanguards
                        </h2>
                    ...
                    <div className="py-10 lg:py-12 border-t border-white/5 opacity-40">

                      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 max-w-5xl">

                        <div className="space-y-2">

                          <p className="text-[9px] font-mono tracking-[0.4em] uppercase text-white/40">
                            Manifesto_Protocol // 047
                          </p>

                          <h4 className="text-sm font-bold tracking-widest uppercase max-w-md leading-relaxed">
                            "Music is the only frequency that survives the flesh. We do not lose
                            artists; we archive their souls into the master signal."
                          </h4>
                ...
                {view === "search" && (
                  <section className="min-h-screen">
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-black italic uppercase tracking-tighter mb-8 lg:mb-12">
                      Search_Results
                    </h1>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 lg:gap-8">
                      ...
                      {searchResults.length > 0 ? (
                        ...
                        <p className="text-white/20 font-bold tracking-widest uppercase">
                          No_Data_Found
                        </p>
                      )}
